		...
		<div className="mx-auto max-w-6xl">
			<div className="grid gap-10 lg:grid-cols-[1fr_0.9fr] lg:items-start">
				<div>
					...
					<h2 className="mt-3 text-4xl font-semibold tracking-tight text-[#073b5c] sm:text-5xl">Find Your Future at Northern</h2>
				</div>
				<div className="space-y-5 text-lg leading-8 text-slate-600">
					<p>
						Whether you are still exploring or already know your direction, discover academic options aligned with your interests, career goals, and preferred way to learn.
					</p>
					<p>
...
export const AreaOfInterestGrid = ({ areas, programCounts, activeArea, onSelectArea }) => (
	<section id="areas-of-interest" aria-labelledby="areas-heading" className="scroll-mt-20">
		<div className="max-w-3xl">
			...
			<h2 id="areas-heading" className="mt-3 text-4xl font-semibold tracking-tight text-[#073b5c] sm:text-5xl">
