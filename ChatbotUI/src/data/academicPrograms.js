...
const NNMC_CATALOG_PROGRAMS = [
	...
	{ title: "RN to BSN", category: "Bachelor of Science in Nursing", credits: 120, creditsText: "120–122", url: "https://catalog.nnmc.edu/preview_program.php?catoid=3&poid=178&returnto=110" },
...
export const ACADEMIC_PROGRAMS = NNMC_CATALOG_PROGRAMS.map((program) => {
	...
	return {
		...
		creditsDisplay: program.creditsText || program.credits,
